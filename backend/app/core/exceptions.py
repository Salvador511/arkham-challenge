...
- Validation/Data Errors: 400-404 range
- Processing Errors: 500 range
- EIA Connector Errors: External API operations
- Extraction/Refresh Errors: Data refresh operations
"""
...
class ExtractionMessages:
    ...
    INCREMENTAL_EXTRACTION_STARTED = "Incremental extraction started. Please check back shortly."
